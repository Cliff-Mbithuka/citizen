...
router.post('/', authenticateToken, checkRole('user', "admin"), incidentController.createIncident);
...
router.delete('/:id', authenticateToken, checkRole('user', "admin"), incidentController.deleteIncident);
